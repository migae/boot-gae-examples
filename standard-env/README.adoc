...
[source,sh]
----
greeter/ $ boot gae/monitor target --no-clean --dir $HOME/boot/boot-gae-examples/standard-env/microservices-app/target/greeter
----

NOTE:  This is admittedly clumsy; the TODO list includes making this simpler.
